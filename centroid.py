...
centroid_x, centroid_y, sigma_x, sigma_y = odlib.find_centroid("inputs/sampleimage.fits", 351, 154, 4, 5, "mean")
print()
...
# Works
print(odlib.find_centroid("inputs/sampleimage.fits", 530, 299, 3, 5, "mean"))
